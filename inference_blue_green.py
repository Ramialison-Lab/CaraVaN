...
full_pipeline = joblib.load(f'model_weights/full_pipeline_clinvar_blue_green.joblib')
print("LOADED FULL PIPELINE")

pca = joblib.load(f'model_weights/pca_clinvar_blue_green.joblib')
print("LOADED FULL PCA")

clf_full = joblib.load(f'model_weights/clf_full_clinvar_blue_green.joblib')
...
positions.to_csv(f"predictions/proba_predictions/{CHROMOSOME}_scores_clinvar_blue_green.txt", index = False, sep = '\t')
