...
file_path = "/group/tran3/duytran/ngocduy.tran/Python scripts/bedtools_merging/Validation/ensembl_variants_raw_regions.txt"
df.to_csv(file_path, sep='\t', index=False)

# save file to a 
file_path = "/group/tran3/duytran/ngocduy.tran/Python scripts/bedtools_merging/tested_variants/ensembl_variants_raw_regions.txt"
df.to_csv(file_path, sep='\t', index=False)
...
chromosome = 'ensembl_variants_raw_regions'
