...
# Reading variants_file = "/group/tran3/duytran/ngocduy.tran/Python scripts/bedtools_merging/tested_variants/mart_export.txt"

# print hi
df = pd.read_csv("/group/tran3/duytran/ngocduy.tran/Python scripts/bedtools_merging/tested_variants/mart_export.txt", sep ='\t')
...
# save file to a 
file_path = "/group/tran3/duytran/ngocduy.tran/Python scripts/bedtools_merging/Validation/mart_export.txt"
